...
class CryptoSDPModel:
    def __init__(self, price_series):
        ...
        """
        self.price_series = price_series  # The series of prices for the asset
    ...
    def build_state(self):
        ...
        return np.array([
            ...
            self.buy_price if self.stock_owned else 0,  # Price at which stock was bought
    ...
    def transition_fn(self, action):
        ...
        if action == 0:  # Buy
            ...
            reward = -0.005  # Small penalty to discourage unnecessary holding
